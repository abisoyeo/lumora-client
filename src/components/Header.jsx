        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          {canCreateNew && (
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 bg-emerald-600 text-slate-900 rounded-lg hover:bg-emerald-500 transition-all"
            >
          ...
          {user ? (
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-emerald-500 text-slate-900 rounded-lg hover:bg-emerald-400 transition-all"
            >
